...
runlim -t 1800 ./leon --mem --benchmark ./testcases/lazy-datastructures/withOrb/FibonacciMemoized.scala  | tee FibonacciMemoized.out # a few seconds
...
runlim -t 1800 ./leon --mem --benchmark --unrollfactor=2 ./testcases/lazy-datastructures/withOrb/Viterbi.scala | tee Viterbi.out   # ~ 1min
